    ...
    return(
        ...
        <div className="flex w-full min-h-screen">
            <div className="p-4 flex-1">
                <Card cardTitle={"List of Deparments"} addButton={true} text="Add Department" openModal={openModal}>
                    <Gridview<Department> gridviewTitle={""} data={department || []}></Gridview>
                </Card>
            </div>
            <div className="p-4 w-120">
                <Card cardTitle={"Department Form"} addButton={false} openModal={openModal}>
                    SAMPLE FORM
                </Card>
            </div>
        </div>
