...
const getEmployeeById = async(id): Promise<Employee> => {
    var response = await api.get<Employee>(`api/Employee/GetById/${id}`);
    return response.data;
}

const getEmployeeByDepTeam = async(id): Promise<Employee[]> => {
...
const updateEmployee = async(employeeData): Promise<Employee> => {
